type 'a genealogy_visitor = {
  ...
  visit_relationship_value : 'a relationship_modifier option -> relationship_type -> string -> 'a;
...
and 'a relationship_value =
  | RelationshipValue of relationship_modifier option * relationship_type * string

and 'a attribute =
  | Attribute of string * 'a attribute_value
...
let rec accept_genealogy_visitor visitor ast =
  match ast with
  | Parvarzin (id, statements) -> visitor.visit_parvarzin id (List.map (accept_genealogy_visitor visitor) statements)
  | PersonStatement (id, attributes) -> visitor.visit_person_statement id (List.map (accept_genealogy_visitor_attribute visitor) attributes)
  | RelationshipStatement (id, relationships) -> visitor.visit_relationship_statement id (List.map (accept_genealogy_visitor_relationship_value visitor) relationships)
...
and accept_genealogy_visitor_attribute visitor attribute =
  ...
  | Attribute (name, value) -> visitor.visit_attribute name (accept_genealogy_visitor_attribute_value visitor value)
...
and accept_genealogy_visitor_relationship_value visitor relationship_value =
  ...
  | RelationshipValue (modifier, relType, id) -> visitor.visit_relationship_value modifier relType id
